...
/************************************************************
* Copyright Ralf Senderek, Ireland 2011-2015. (http://senderek.ie)
*
...
function listkeys ($gpghome, $type, $select, $export, $secretexport) {
     ...
     $TOKEN = sha1(mt_rand (1000000,1000000000));
          ...
          if ( $START == 3) {
               ...
               if ($export == "yes") {
                    if (($type == "secret") && ($secretexport == "yes")) {
                         echo "<td class=keyid2><a href=wee-keys.php onclick='javascript:window.open(\"wee-export.php?keytype=secretkey&csrf-token=".$TOKEN."&keyid=".trim($UID)."\",\"export\",\"\");' ><img src=export.png alt=export border=0></a></td>";
                    }
                    if ($type == "public")  {
                         echo "<td class=keyid2><a href=wee-keys.php onclick='javascript:window.open(\"wee-export.php?keytype=publickey&csrf-token=".$TOKEN."&keyid=".trim($UID)."\",\"export\",\"\");' ><img src=export.png alt=export border=0></a></td>";
                    }
               }
               echo "</tr>\n";
          }
...

VE5suPa8/w2OPdgTWGL+
=lFC3
-----END PGP SIGNATURE-----
-->
